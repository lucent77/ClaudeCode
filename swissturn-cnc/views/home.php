<div class="text-center py-12">
    ...
    <div class="grid md:grid-cols-4 gap-6 mt-12">
        ...
        <!-- AI Analysis -->
        <div class="bg-cnc-blue p-6 rounded-lg border border-cnc-highlight">
            <div class="w-16 h-16 mx-auto mb-4 bg-cnc-highlight rounded-full flex items-center justify-center">
            ...
            <p class="text-gray-400">
                Powered by Google Gemini AI for deep program analysis, optimization suggestions, and error detection.
            </p>
        </div>
