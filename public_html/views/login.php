...
<head>
    ...
    <title>Login - Design Confirm System</title>
    ...
    <div class="w-full max-w-md" x-data="loginForm()">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-primary-600 px-8 py-6 text-center">
                ...
                <h1 class="text-2xl font-bold text-white">Design Confirm</h1>
                <p class="text-primary-100 text-sm mt-1">Dental Case Management System</p>
            </div>
            ...
            <form @submit.prevent="login()" class="p-8">
                ...
                <div class="flex items-center justify-between mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" x-model="remember" class="w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500">
                ...
                <button
                    type="submit"
                    :disabled="loading"
                    class="w-full bg-primary-600 hover:bg-primary-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
