<div class="min-h-screen flex items-center justify-center gradient-primary py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            <form method="POST" action="/login" class="space-y-6" x-data="{ showPassword: false }">
                ...
                <div>
                    <button
                        type="submit"
                        class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white gradient-primary hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition shadow-lg">
            ...
            <div class="mt-6 text-center text-xs text-gray-500">
                <p>Default credentials: <code class="bg-gray-100 px-2 py-1 rounded">admin</code> / <code class="bg-gray-100 px-2 py-1 rounded">Admin@123</code></p>
                <p class="mt-1">Change password immediately after first login</p>
            </div>
        </div>

        <!-- Footer -->
        <div class="text-center text-white text-sm">
            <p>&copy; <?= date('Y') ?> CREODENT. All rights reserved.</p>
            <p class="mt-1 text-indigo-100">Version 2.0.0</p>
        </div>
    </div>
</div>
