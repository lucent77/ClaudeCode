            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Used for login (3-100 characters)</p>
                    </div>
                    ...
                    <div x-data="{ showPassword: false }">
                        ...
                        <p class="mt-1 text-xs text-gray-500">Min 8 characters, include uppercase, lowercase, and number</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="mt-6 bg-gray-50 rounded-lg p-4">
                    ...
                    <ul class="space-y-1 text-xs text-gray-600">
                        <?php if (\App\Core\Session::hasRole('super_admin')): ?>
                            <li><strong>Super Admin:</strong> Full system access, can manage all users including admins</li>
                        <?php endif; ?>
                        <li><strong>Admin:</strong> Manage cases, users (except super admins), imports, and settings</li>
                        <li><strong>Manager:</strong> Manage department cases, assign work to workers</li>
                        <li><strong>Worker:</strong> View and update assigned cases only</li>
                    </ul>
                </div>
            </div>
