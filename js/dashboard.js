...
async function loadStatistics() {
    try {
        const response = await fetch('/api.php/cases/stats', {
...
async function loadCases() {
    try {
        ...
        const response = await fetch('/api.php/cases', {
            headers: getAuthHeaders()
        });
...
function viewCase(caseId) {
    window.location.href = `/case-detail.php?id=${caseId}`;
}
...
async function deleteCase(caseId) {
    ...
    try {
        const response = await fetch(`/api.php/cases/${caseId}`, {
            method: 'DELETE',
            headers: getAuthHeaders()
        });
...
async function syncWithSlack() {
    ...
    try {
        ...
        const response = await fetch('/api.php/sync', {
            method: 'POST',
            headers: getAuthHeaders()
        });
